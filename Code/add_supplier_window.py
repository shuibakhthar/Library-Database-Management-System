...
#    Feb 18, 2020 05:27:28 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    add_supplier_window_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    add_supplier_window_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def add_supplier(self):
        self.add_supplier1(self.Supplier_ID_Entry.get(), self.Supplier_Name_Entry.get(), self.Address_Entry.get(), self.Contact_Entry.get(), self.Email_Entry.get())
    def add_supplier1(self, supplier_id, supplier_name, address, contact, email):
        ...
        try:
            ...
            self.cursor.execute("INSERT INTO LMS_SUPPLIERS_DETAILS VALUES(:1,:2,:3,:4,:5)", (supplier_id, supplier_name, address, contact, email))
            self.conn.commit()
    ...
    def update_supplier(self):
        self.update_supplier1(self.Supplier_ID_Entry.get(), self.Supplier_Name_Entry.get(), self.Address_Entry.get(),self.Contact_Entry.get(), self.Email_Entry.get())
    def update_supplier1(self,supplier_id,supplier_name,address,contact,email):
        try:
            self.conn = cx_Oracle.connect('HR/root')
            self.cursor = self.conn.cursor()
            try:
        ...
        try:
            ...
            if supplier_name != '':
                self.cursor.execute(("UPDATE LMS_SUPPLIERS_DETAILS SET SUPPLIER_NAME = :1 WHERE SUPPLIER_ID = :2"),(supplier_name,supplier_id))
                self.conn.commit()
            if address !='':
                self.cursor.execute(("UPDATE LMS_SUPPLIERS_DETAILS SET ADDRESS = :1 WHERE SUPPLIER_ID = :2"),
                                    (address, supplier_id))
                self.conn.commit()
            if contact !='':
                self.cursor.execute(("UPDATE LMS_SUPPLIERS_DETAILS SET CONTACT = :1 WHERE SUPPLIER_ID = :2"),
                                    (contact, supplier_id))
                self.conn.commit()
            if email !='':
                self.cursor.execute(("UPDATE LMS_SUPPLIERS_DETAILS SET EMAIL = :1 WHERE SUPPLIER_ID = :2"),
                                    (email, supplier_id))
                self.conn.commit()
    ...
    def __init__(self, Add_Supplier_Window=None):
        ...
        Add_Supplier_Window.geometry("1232x741+310+64")
        Add_Supplier_Window.minsize(148, 1)
        Add_Supplier_Window.maxsize(4112, 1055)
        Add_Supplier_Window.resizable(0, 0)
        Add_Supplier_Window.title("ADD SUPPLIER WINDOW")
        Add_Supplier_Window.configure(background="#b42cc7")

        self.Add_Supplier_Window_Frame = tk.Frame(Add_Supplier_Window)
        self.Add_Supplier_Window_Frame.place(relx=0.049, rely=0.063, relheight=0.884
                                             , relwidth=0.916)
        self.Add_Supplier_Window_Frame.configure(relief='groove')
        self.Add_Supplier_Window_Frame.configure(borderwidth="2")
        self.Add_Supplier_Window_Frame.configure(relief="groove")
        self.Add_Supplier_Window_Frame.configure(background="#5f86d8")

        self.Private_Label = tk.Label(self.Add_Supplier_Window_Frame)
        ...
        self.Date_Label = tk.Label(self.Add_Supplier_Window_Frame)
        ...
        self.Datenow_Label = tk.Label(self.Add_Supplier_Window_Frame)
        ...
        self.Time_LAbel = tk.Label(self.Add_Supplier_Window_Frame)
        ...
        self.Timenow_Label = tk.Label(self.Add_Supplier_Window_Frame)
        ...
        self.Supplier_ID_Label = tk.Label(self.Add_Supplier_Window_Frame)
        self.Supplier_ID_Label.place(relx=0.124, rely=0.382, height=36, width=152)
        ...
        self.Supplier_Name_Label = tk.Label(self.Add_Supplier_Window_Frame)
        self.Supplier_Name_Label.place(relx=0.124, rely=0.458, height=36, width=152)

        self.Supplier_Name_Label.configure(background="#d9d9d9")
        self.Supplier_Name_Label.configure(disabledforeground="#a3a3a3")
        self.Supplier_Name_Label.configure(font=font12)
        self.Supplier_Name_Label.configure(foreground="#000000")
        self.Supplier_Name_Label.configure(text='''Supplier Name:''')

        self.Supplier_ID_Entry = tk.Entry(self.Add_Supplier_Window_Frame)
        self.Supplier_ID_Entry.place(relx=0.266, rely=0.382, height=34
                                     , relwidth=0.181)
        ...
        self.Supplier_Name_Entry = tk.Entry(self.Add_Supplier_Window_Frame)
        self.Supplier_Name_Entry.place(relx=0.266, rely=0.458, height=34
                                       , relwidth=0.181)
        self.Supplier_Name_Entry.configure(background="white")
        self.Supplier_Name_Entry.configure(disabledforeground="#a3a3a3")
        self.Supplier_Name_Entry.configure(font=font12)
        self.Supplier_Name_Entry.configure(foreground="#000000")
        self.Supplier_Name_Entry.configure(insertbackground="black")

        self.Address_Label = tk.Label(self.Add_Supplier_Window_Frame)
        self.Address_Label.place(relx=0.124, rely=0.534, height=36, width=152)
        self.Address_Label.configure(background="#d9d9d9")
        self.Address_Label.configure(disabledforeground="#a3a3a3")
        self.Address_Label.configure(font=font12)
        self.Address_Label.configure(foreground="#000000")
        self.Address_Label.configure(text='''Address:''')

        self.Address_Entry = tk.Entry(self.Add_Supplier_Window_Frame)
        self.Address_Entry.place(relx=0.266, rely=0.534, height=34
                                 , relwidth=0.181)
        self.Address_Entry.configure(background="white")
        self.Address_Entry.configure(disabledforeground="#a3a3a3")
        self.Address_Entry.configure(font=font12)
        self.Address_Entry.configure(foreground="#000000")
        self.Address_Entry.configure(insertbackground="black")

        self.Contact_Label = tk.Label(self.Add_Supplier_Window_Frame)
        self.Contact_Label.place(relx=0.124, rely=0.611, height=36, width=152)
        self.Contact_Label.configure(background="#d9d9d9")
        self.Contact_Label.configure(disabledforeground="#a3a3a3")
        self.Contact_Label.configure(font=font12)
        self.Contact_Label.configure(foreground="#000000")
        self.Contact_Label.configure(text='''Contact:''')

        self.Contact_Entry = tk.Entry(self.Add_Supplier_Window_Frame)
        self.Contact_Entry.place(relx=0.266, rely=0.611, height=34
                                 , relwidth=0.181)
        self.Contact_Entry.configure(background="white")
        self.Contact_Entry.configure(disabledforeground="#a3a3a3")
        self.Contact_Entry.configure(font=font12)
        self.Contact_Entry.configure(foreground="#000000")
        self.Contact_Entry.configure(insertbackground="black")

        self.Email_Label = tk.Label(self.Add_Supplier_Window_Frame)
        self.Email_Label.place(relx=0.124, rely=0.687, height=36, width=152)
        ...
        self.Email_Entry = tk.Entry(self.Add_Supplier_Window_Frame)
        self.Email_Entry.place(relx=0.266, rely=0.687, height=34
                               , relwidth=0.181)
        self.Email_Entry.configure(background="white")
        self.Email_Entry.configure(disabledforeground="#a3a3a3")
        self.Email_Entry.configure(font=font12)
        self.Email_Entry.configure(foreground="#000000")
        self.Email_Entry.configure(insertbackground="black")

        self.Add_Button = tk.Button(self.Add_Supplier_Window_Frame)
        ...
        self.Add_Button.configure(command=self.add_supplier, text='''ADD''')

        self.Update_Button = tk.Button(self.Add_Supplier_Window_Frame)
        ...
        self.Update_Button.configure(command=self.update_supplier, text='''UPDATE''')

        self.menubar = tk.Menu(Add_Supplier_Window, font=font9, bg=_bgcolor, fg=_fgcolor)
        Add_Supplier_Window.configure(menu=self.menubar)

        self.sub_menu = tk.Menu(Add_Supplier_Window, tearoff=0)
        ...
        self.sub_menu.add_command(
            ...
            foreground="#000000",
            label="Exit",
            command=add_supplier_window_support.destroy_window)
