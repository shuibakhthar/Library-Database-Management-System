...
#    Feb 18, 2020 07:59:43 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    delete_supplier_window_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    delete_supplier_window_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def delete_supplier(self):
        self.delete_supplier1(self.Supplier_ID_Entry.get())
    def delete_supplier1(self,supplier_id):
        try:
        ...
        try:
            statement='delete from LMS_SUPPLIERS_DETAILS where SUPPLIER_ID=:1'
            self.cursor.execute(statement,{'1':supplier_id})
            self.conn.commit()
    ...
    def __init__(self, Delete_Supplier_Winodw=None):
        try:
            self.conn = cx_Oracle.connect('HR/root')
            self.cursor = self.conn.cursor()
            try:
        ...
        Delete_Supplier_Winodw.geometry("1232x741+310+64")
        Delete_Supplier_Winodw.minsize(148, 1)
        Delete_Supplier_Winodw.maxsize(4112, 1055)
        Delete_Supplier_Winodw.resizable(0, 0)
        Delete_Supplier_Winodw.title("DELETE SUPPLIER WINDOW")
        Delete_Supplier_Winodw.configure(background="#b43cc7")

        self.Delete_Supplier_Window_Frame = tk.Frame(Delete_Supplier_Winodw)
        self.Delete_Supplier_Window_Frame.place(relx=0.049, rely=0.063, relheight=0.884
                                                , relwidth=0.916)
        self.Delete_Supplier_Window_Frame.configure(relief='groove')
        self.Delete_Supplier_Window_Frame.configure(borderwidth="2")
        self.Delete_Supplier_Window_Frame.configure(relief="groove")
        self.Delete_Supplier_Window_Frame.configure(background="#5f86d8")

        self.Private_Label = tk.Label(self.Delete_Supplier_Window_Frame)
        ...
        self.Date_Label = tk.Label(self.Delete_Supplier_Window_Frame)
        ...
        self.Datenow_Label = tk.Label(self.Delete_Supplier_Window_Frame)
        ...
        self.Time_Label = tk.Label(self.Delete_Supplier_Window_Frame)
        ...
        self.Timenow_Label = tk.Label(self.Delete_Supplier_Window_Frame)
        ...
        self.Supplier_ID_Label = tk.Label(self.Delete_Supplier_Window_Frame)
        ...
        self.Supplier_ID_Entry = tk.Entry(self.Delete_Supplier_Window_Frame)
        ...
        self.Delete_Button = tk.Button(self.Delete_Supplier_Window_Frame)
        ...
        self.Delete_Button.configure(command=self.delete_supplier, text='''DELETE''')

        self.menubar = tk.Menu(Delete_Supplier_Winodw, font=font9, bg=_bgcolor, fg=_fgcolor)
        Delete_Supplier_Winodw.configure(menu=self.menubar)

        self.sub_menu = tk.Menu(Delete_Supplier_Winodw, tearoff=0)
        ...
        self.sub_menu.add_command(
            ...
            foreground="#000000",
            label="Exit",
            command=delete_supplier_window_support.destroy_window)
