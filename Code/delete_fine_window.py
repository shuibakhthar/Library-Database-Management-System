...
#    Feb 18, 2020 08:00:33 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    delete_fine_window_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    delete_fine_window_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def delete_fine(self):
        self.delete_fine1(self.Fine_Range_Entry.get())

    def delete_fine1(self, fine_range):
        try:
        ...
        try:
            statement = 'delete from LMS_FINE_DETAILS where FINE_RANGE=:1'
            self.cursor.execute(statement, {'1': fine_range})
            self.conn.commit()
            messagebox.showerror("Success", "Successfully Deleted")
        except Exception as e:
            messagebox.showerror("Error in deleting", e)

    def __init__(self, Delete_Fine_Window=None):
        ...
        Delete_Fine_Window.geometry("1232x741+310+64")
        Delete_Fine_Window.minsize(148, 1)
        Delete_Fine_Window.maxsize(4112, 1055)
        Delete_Fine_Window.resizable(0, 0)
        Delete_Fine_Window.title("DELETE FINE WINDOW")
        Delete_Fine_Window.configure(background="#b43cc7")

        self.Delete_Fine_Window_Frame = tk.Frame(Delete_Fine_Window)
        self.Delete_Fine_Window_Frame.place(relx=0.049, rely=0.063, relheight=0.884
                                            , relwidth=0.916)
        self.Delete_Fine_Window_Frame.configure(relief='groove')
        self.Delete_Fine_Window_Frame.configure(borderwidth="2")
        self.Delete_Fine_Window_Frame.configure(relief="groove")
        self.Delete_Fine_Window_Frame.configure(background="#5f86d8")

        self.Private_Label = tk.Label(self.Delete_Fine_Window_Frame)
        ...
        self.Date_Label = tk.Label(self.Delete_Fine_Window_Frame)
        ...
        self.Datenow_Label = tk.Label(self.Delete_Fine_Window_Frame)
        ...
        self.Time_Label = tk.Label(self.Delete_Fine_Window_Frame)
        ...
        self.Timenow_Label = tk.Label(self.Delete_Fine_Window_Frame)
        ...
        self.Fine_Range_Label = tk.Label(self.Delete_Fine_Window_Frame)
        ...
        self.Fine_Range_Entry = tk.Entry(self.Delete_Fine_Window_Frame)
        ...
        self.Delete_Button = tk.Button(self.Delete_Fine_Window_Frame)
        ...
        self.Delete_Button.configure(command=self.delete_fine, text='''DELETE''')

        self.menubar = tk.Menu(Delete_Fine_Window, font=font9, bg=_bgcolor, fg=_fgcolor)
        Delete_Fine_Window.configure(menu=self.menubar)

        self.sub_menu = tk.Menu(Delete_Fine_Window, tearoff=0)
        ...
        self.sub_menu.add_command(
            ...
            foreground="#000000",
            label="Exit",
            command=delete_fine_window_support.destroy_window)
