...
#    Feb 18, 2020 08:04:16 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    delete_bookissue_window_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    delete_bookissue_window_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def delete_bookissue(self):
        self.delete_bookissue1(self.Bookissue_NO_Entry.get())

    def delete_bookissue1(self, bookissue_no):
        try:
        ...
        try:
            statement = 'delete from LMS_BOOK_ISSUE where BOOK_ISSUE_NO=:1'
            self.cursor.execute(statement, {'1': bookissue_no})
            self.conn.commit()
            messagebox.showerror("Success", "Successfully Deleted")
        except Exception as e:
            messagebox.showerror("Error in deleting", e)

    def __init__(self, Delete_Bookissue_Window=None):
        try:
            self.conn = cx_Oracle.connect('HR/root')
            self.cursor = self.conn.cursor()
            try:
        ...
        Delete_Bookissue_Window.geometry("1232x741+310+64")
        Delete_Bookissue_Window.minsize(148, 1)
        Delete_Bookissue_Window.maxsize(4112, 1055)
        Delete_Bookissue_Window.resizable(0, 0)
        Delete_Bookissue_Window.title("DELETE BOOK ISSUE WINDOW")
        Delete_Bookissue_Window.configure(background="#b42cc7")

        self.Delete_Bookissue_Window_Frame = tk.Frame(Delete_Bookissue_Window)
        self.Delete_Bookissue_Window_Frame.place(relx=0.049, rely=0.063, relheight=0.884
                                                 , relwidth=0.916)
        self.Delete_Bookissue_Window_Frame.configure(relief='groove')
        self.Delete_Bookissue_Window_Frame.configure(borderwidth="2")
        self.Delete_Bookissue_Window_Frame.configure(relief="groove")
        self.Delete_Bookissue_Window_Frame.configure(background="#5f86d8")

        self.Private_Label = tk.Label(self.Delete_Bookissue_Window_Frame)
        ...
        self.Date_Label = tk.Label(self.Delete_Bookissue_Window_Frame)
        ...
        self.Datenow_Label = tk.Label(self.Delete_Bookissue_Window_Frame)
        ...
        self.Time_Label = tk.Label(self.Delete_Bookissue_Window_Frame)
        ...
        self.Timenow_Label = tk.Label(self.Delete_Bookissue_Window_Frame)
        ...
        self.Bookissue_NO_Label = tk.Label(self.Delete_Bookissue_Window_Frame)
        ...
        self.Bookissue_NO_Entry = tk.Entry(self.Delete_Bookissue_Window_Frame)
        ...
        self.Delete_Button = tk.Button(self.Delete_Bookissue_Window_Frame)
        ...
        self.Delete_Button.configure(command=self.delete_bookissue, text='''DELETE''')

        self.menubar = tk.Menu(Delete_Bookissue_Window, font=font9, bg=_bgcolor, fg=_fgcolor)
        Delete_Bookissue_Window.configure(menu=self.menubar)

        self.sub_menu = tk.Menu(Delete_Bookissue_Window, tearoff=0)
        ...
        self.sub_menu.add_command(
            ...
            foreground="#000000",
            label="Exit",
            command=delete_bookissue_window_support.destroy_window)
