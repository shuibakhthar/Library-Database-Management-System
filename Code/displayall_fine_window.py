...
#    Feb 17, 2020 04:22:24 PM IST  platform: Windows NT
...
import displayall_fine_window_support
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    displayall_fine_window_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    displayall_fine_window_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def show_all(self):
        try:
            ...
            self.cursor.execute('select * from LMS_FINE_DETAILS order by FINE_RANGE')
            ...
            try:
                for i in range(0, len(table_array)):
                    self.Displayall_Fine_Scrolledlistbox.insert("", 'end', text="#", values=row[i])
                    # table_array1 = table_array[i]
                    # for j in range(0, len(table_array1)):
                    #     self.Displayall_Fine_Scrolledlistbox.insert(j, table_array[j])
            except:
                print("hi")
    ...
    def refresh(self):
        self.Displayall_Fine_Scrolledlistbox.delete(*self.Displayall_Fine_Scrolledlistbox.get_children())
        self.show_all()

    def __init__(self, Displayall_Fine_Window=None):
        ...
        Displayall_Fine_Window.geometry("1232x741+310+64")
        Displayall_Fine_Window.minsize(148, 1)
        Displayall_Fine_Window.maxsize(4112, 1055)
        Displayall_Fine_Window.resizable(0, 0)
        Displayall_Fine_Window.title("FINE - ALL FINE WINDOW")
        Displayall_Fine_Window.configure(background="#b42cc7")

        self.Displayall_Fine_Window_Frame = tk.Frame(Displayall_Fine_Window)
        self.Displayall_Fine_Window_Frame.place(relx=0.049, rely=0.061
                                                , relheight=0.884, relwidth=0.91)
        self.Displayall_Fine_Window_Frame.configure(relief='groove')
        self.Displayall_Fine_Window_Frame.configure(borderwidth="2")
        self.Displayall_Fine_Window_Frame.configure(relief="groove")
        self.Displayall_Fine_Window_Frame.configure(background="#5f86d8")

        self.Private_Label = tk.Label(self.Displayall_Fine_Window_Frame)
        ...
        self.Date_Label = tk.Label(self.Displayall_Fine_Window_Frame)
        ...
        self.Datenow_Label = tk.Label(self.Displayall_Fine_Window_Frame)
        ...
        self.Time_Label = tk.Label(self.Displayall_Fine_Window_Frame)
        ...
        self.Timenow_Label = tk.Label(self.Displayall_Fine_Window_Frame)
        ...
        self.Refresh_Button = tk.Button(self.Displayall_Fine_Window_Frame)
        ...
        self.Displayall_Fine_Scrolledlistbox = ScrolledTreeView(Displayall_Fine_Window)
        self.Displayall_Fine_Scrolledlistbox.place(relx=0.075, rely=0.443
        ...
        self.Displayall_Fine_Scrolledlistbox.configure(columns=("Fine_Range", "Fine_Amount"))
        # self.Displayall_Fine_Scrolledlistbox.configure(font="-family {Helvatica} -size 15 -weight normal -slant"  \
        #     " roman -underline 0 -overstrike 0")
        # build_treeview_support starting.
        self.Displayall_Fine_Scrolledlistbox.heading("#0", text="#")
        self.Displayall_Fine_Scrolledlistbox.heading("#0", anchor="center")
        self.Displayall_Fine_Scrolledlistbox.column("#0", width="0")
        self.Displayall_Fine_Scrolledlistbox.column("#0", minwidth="0")
        self.Displayall_Fine_Scrolledlistbox.column("#0", stretch="0")
        self.Displayall_Fine_Scrolledlistbox.column("#0", anchor="center")

        self.Displayall_Fine_Scrolledlistbox.heading("Fine_Range", text="Fine Range")
        self.Displayall_Fine_Scrolledlistbox.heading("Fine_Range", anchor="center")
        self.Displayall_Fine_Scrolledlistbox.column("Fine_Range", width="150")
        self.Displayall_Fine_Scrolledlistbox.column("Fine_Range", minwidth="20")
        self.Displayall_Fine_Scrolledlistbox.column("Fine_Range", stretch="1")
        self.Displayall_Fine_Scrolledlistbox.column("Fine_Range", anchor="center")

        self.Displayall_Fine_Scrolledlistbox.heading("Fine_Amount", text="Fine Amount")
        self.Displayall_Fine_Scrolledlistbox.heading("Fine_Amount", anchor="center")
        self.Displayall_Fine_Scrolledlistbox.column("Fine_Amount", width="200")
        self.Displayall_Fine_Scrolledlistbox.column("Fine_Amount", minwidth="20")
        self.Displayall_Fine_Scrolledlistbox.column("Fine_Amount", stretch="1")
        self.Displayall_Fine_Scrolledlistbox.column("Fine_Amount", anchor="center")

        # self.Displayall_Fine_Scrolledlistbox = ScrolledListBox(self.Displayall_Fine_Window_Frame)
        # self.Displayall_Fine_Scrolledlistbox.place(relx=0.116, rely=0.382, relheight=0.53
        #                                            , relwidth=0.807)
        # self.Displayall_Fine_Scrolledlistbox.configure(background="white")
        # self.Displayall_Fine_Scrolledlistbox.configure(disabledforeground="#a3a3a3")
        # self.Displayall_Fine_Scrolledlistbox.configure(font=font10)
        # self.Displayall_Fine_Scrolledlistbox.configure(foreground="black")
        # self.Displayall_Fine_Scrolledlistbox.configure(highlightbackground="#d9d9d9")
        # self.Displayall_Fine_Scrolledlistbox.configure(highlightcolor="#d9d9d9")
        # self.Displayall_Fine_Scrolledlistbox.configure(selectbackground="#c4c4c4")
        # self.Displayall_Fine_Scrolledlistbox.configure(selectforeground="black")
        # # self.Displayall_Fine_Scrolledlistbox.insert(0,"hi")
        self.show_all()

        self.menubar = tk.Menu(Displayall_Fine_Window, font=font9, bg=_bgcolor, fg=_fgcolor)
        Displayall_Fine_Window.configure(menu=self.menubar)

        self.File = tk.Menu(Displayall_Fine_Window, tearoff=0)
        ...
        self.File.add_command(
            ...
            foreground="#000000",
            label="Exit",
            command=displayall_fine_window_support.destroy_window)
        self.Edit = tk.Menu(Displayall_Fine_Window, tearoff=0)
